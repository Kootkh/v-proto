...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // Электронная почта пользователя
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Пароль пользователя
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // Идентификатор приложения
}
...
type LoginResponse struct {
	...
	Token  string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`                  // Токен пользователя
	UserId int64  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // Идентификатор пользователя
}
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x3e, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x49, 0x64, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x71,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x10, 0x5a, 0x0e, 0x76, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x31, 0x3b, 0x76, 0x61, 0x70, 0x69, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
