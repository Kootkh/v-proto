...
type APIServiceClient interface {
	...
	GetAPI(ctx context.Context, in *APIRequest, opts ...grpc.CallOption) (*APIResponse, error)
}
...
func (c *aPIServiceClient) GetAPI(ctx context.Context, in *APIRequest, opts ...grpc.CallOption) (*APIResponse, error) {
	out := new(APIResponse)
	err := c.cc.Invoke(ctx, "/api.APIService/GetAPI", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type APIServiceServer interface {
	...
	GetAPI(context.Context, *APIRequest) (*APIResponse, error)
...
func (UnimplementedAPIServiceServer) GetAPI(context.Context, *APIRequest) (*APIResponse, error) {
...
func _APIService_GetAPI_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.APIService/GetAPI",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServiceServer).GetAPI(ctx, req.(*APIRequest))
	}
	return interceptor(ctx, in, info, handler)
}
